...
using JFine.Plugins.YUNLU.Domain.Repository.YL_AlterNotify;
using JFine.Cache;
...
namespace JFine.Plugins.YUNLU.Busines.YL_AlterNotify
{	
	/// <summary>
	/// YL_AlterNotifyBLL
	/// </summary>	
	public class YL_AlterNotifyBLL
	{
	    private IYL_AlterNotifyRepository service=new YL_AlterNotifyRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="YL_AlterNotifyCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<YL_AlterNotifyEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<YL_AlterNotifyEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<YL_AlterNotifyEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<YL_AlterNotifyEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<YL_AlterNotifyEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, YL_AlterNotifyEntity yL_AlterNotifyEntity)
        {
            try
            {
                service.SaveForm(keyValue, yL_AlterNotifyEntity);
                CacheFactory.Cache().WriteCache(cacheKey,yL_AlterNotifyEntity);
            }
            catch (Exception)
            {
                throw;
