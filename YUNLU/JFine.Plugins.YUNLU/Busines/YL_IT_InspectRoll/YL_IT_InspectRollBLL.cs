...
using JFine.Plugins.YUNLU.Domain.Repository.YL_IT_InspectRoll;
using JFine.Cache;
...
namespace JFine.Plugins.YUNLU.Busines.YL_IT_InspectRoll
{	
	/// <summary>
	/// YL_IT_InspectRollBLL
	/// </summary>	
	public class YL_IT_InspectRollBLL
	{
	    private IYL_IT_InspectRollRepository service=new YL_IT_InspectRollRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="YL_IT_InspectRollCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<YL_IT_InspectRollEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<YL_IT_InspectRollEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<YL_IT_InspectRollEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<YL_IT_InspectRollEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<YL_IT_InspectRollEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, YL_IT_InspectRollEntity yL_IT_InspectRollEntity)
        {
            try
            {
                service.SaveForm(keyValue, yL_IT_InspectRollEntity);
                CacheFactory.Cache().WriteCache(cacheKey,yL_IT_InspectRollEntity);
            }
            catch (Exception)
            {
                throw;
