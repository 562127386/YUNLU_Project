    ...
    $.jfinetab = {
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="JFine_iframe" id="iframe_' + dataId + '" name="iframe_' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataId + '" data-url="' + dataUrl + '"  data-parentId="' + dataId + '" seamless></iframe>';
        ...
        addTabContent: function (url, title, id, parentId) {
            ...
            if (flag) {
                ...
                $('.menuTab').removeClass('active');
                var str1 = '<iframe class="JFine_iframe" id="iframe_' + dataId + '" name="iframe_' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataId + '" data-url="' + dataUrl + '"  data-parentId="' + parentId + '"  seamless></iframe>';
                $('.mainContent').find('iframe.JFine_iframe').hide();
                $('.mainContent').append(str1);
                $.loading(true);
                $('.mainContent iframe:visible').load(function () {
