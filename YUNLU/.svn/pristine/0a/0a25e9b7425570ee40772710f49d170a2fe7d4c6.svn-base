...
using JFine.Plugins.YUNLU.Domain.Repository.YL_IT_FirstConfirm;
using JFine.Cache;
...
namespace JFine.Plugins.YUNLU.Busines.YL_IT_FirstConfirm
{	
	/// <summary>
	/// YL_IT_FirstConfirmBLL
	/// </summary>	
	public class YL_IT_FirstConfirmBLL
	{
	    private IYL_IT_FirstConfirmRepository service=new YL_IT_FirstConfirmRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="YL_IT_FirstConfirmCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<YL_IT_FirstConfirmEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<YL_IT_FirstConfirmEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<YL_IT_FirstConfirmEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<YL_IT_FirstConfirmEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<YL_IT_FirstConfirmEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, YL_IT_FirstConfirmEntity yL_IT_FirstConfirmEntity)
        {
            try
            {
                service.SaveForm(keyValue, yL_IT_FirstConfirmEntity);
                CacheFactory.Cache().WriteCache(cacheKey,yL_IT_FirstConfirmEntity);
            }
            catch (Exception)
            {
                throw;
