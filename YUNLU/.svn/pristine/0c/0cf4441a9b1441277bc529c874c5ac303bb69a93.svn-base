...
using JFine.Plugins.YUNLU.Domain.Repository.YL_CustomerFeedback;
using JFine.Cache;
...
namespace JFine.Plugins.YUNLU.Busines.YL_CustomerFeedback
{	
	/// <summary>
	/// YL_CustomerFeedbackBLL
	/// </summary>	
	public class YL_CustomerFeedbackBLL
	{
	    private IYL_CustomerFeedbackRepository service=new YL_CustomerFeedbackRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="YL_CustomerFeedbackCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<YL_CustomerFeedbackEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<YL_CustomerFeedbackEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<YL_CustomerFeedbackEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<YL_CustomerFeedbackEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<YL_CustomerFeedbackEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, YL_CustomerFeedbackEntity yL_CustomerFeedbackEntity)
        {
            try
            {
                service.SaveForm(keyValue, yL_CustomerFeedbackEntity);
                CacheFactory.Cache().WriteCache(cacheKey,yL_CustomerFeedbackEntity);
            }
            catch (Exception)
            {
                throw;
