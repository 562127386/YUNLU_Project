...
{	
	...
	/// TNRD_SupplierBLL
	/// </summary>	
	public class TNRD_SupplierBLL
	{
	    private ITNRD_SupplierRepository service=new TNRD_SupplierRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="TNRD_SupplierCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<TNRD_SupplierEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<TNRD_SupplierEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<TNRD_SupplierEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<TNRD_SupplierEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<TNRD_SupplierEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, TNRD_SupplierEntity tNRD_SupplierEntity)
        {
            try
            {
                service.SaveForm(keyValue, tNRD_SupplierEntity);
                CacheFactory.Cache().WriteCache(cacheKey,tNRD_SupplierEntity);
            }
            catch (Exception)
            {
                throw;
